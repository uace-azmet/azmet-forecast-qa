...
#create connection to board with data
board <- board_connect()
```
...
# Updates date range selector to current date.
# Unfortunately this happens LAST after the rest of the server code is run
